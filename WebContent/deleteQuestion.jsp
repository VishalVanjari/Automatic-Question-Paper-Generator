              ...
              <table class="table">
                ...
                <%
                						...
                						int tid= TeacherData.getTid();
  										PreparedStatement ps2 = con.prepareStatement("select * from questions where t_id=? order by unit ");
  										ps2.setInt(1, tid);
                ...
                <tbody>
                                <tr>
                                    ...
                                    <td><%=rs2.getInt(5)%></td>
                                    <th scope="row"><a href="QuestionDelete.jsp?q_id=<%=rs2.getInt(1)%>">Delete</a></th>
                                </tr>
                            </tbody>
                            <% 
  								} 
