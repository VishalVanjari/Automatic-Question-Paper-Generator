            ...
            <div class="card-body">
              ...
              <table class="table">
                ...
                <%
  										...
  										PreparedStatement ps2 = con.prepareStatement("select * from teachers where t_status='Not Approved'");
                ...
                <tbody>
                                <tr>
                                    ...
                                    <th scope="row"><a href="ApproveTeacher.jsp?t_id=<%=rs2.getInt(1)%>">Approve</a></th>
                                    <th scope="row"><a href="DisApproveTeacher.jsp?t_id=<%=rs2.getInt(1)%>">X</a></th>
                                </tr>
                            </tbody>
                            <% 
  								} 
